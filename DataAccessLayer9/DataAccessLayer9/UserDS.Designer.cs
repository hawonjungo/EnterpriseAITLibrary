...
SELECT UID, UserName, Password, UserLevel, UserEmail FROM TabUser WHERE (UID = @UID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "SELECT        UID, UserName, Password, UserLevel, UserEmail\r\nFROM            TabU" +
            ...
            this._commandCollection[3].CommandText = "INSERT INTO TabUser\r\n                         (UserName, Password, UserLevel, Use" +
                "rEmail)\r\nVALUES        (@UserName,@Password,@UserLevel,@UserEmail);  \r\nSELECT UI" +
                "D, UserName, Password, UserLevel, UserEmail FROM TabUser WHERE (UID = SCOPE_IDEN" +
                "TITY())";
            ...
            this._commandCollection[4].CommandText = "UPDATE       TabUser\r\nSET                Password = @Password\r\nWHERE        (UID " +
                "= @UID); \r\nSELECT UID, UserName, Password, UserLevel, UserEmail FROM TabUser WHE" +
                "RE (UID = @UID)";
        ...
        public virtual int FillAll(UserDS.TabUserDataTable dataTable) {
        ...
        public virtual UserDS.TabUserDataTable GetDataAll() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDS.TabUserDataTable dataTable = new UserDS.TabUserDataTable();
        ...
        public virtual int FillByUserNamePassword(UserDS.TabUserDataTable dataTable, string USERNAME, string PASSWORD) {
        ...
        public virtual UserDS.TabUserDataTable GetDataByUserNamePassword(string USERNAME, string PASSWORD) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((USERNAME == null)) {
                throw new global::System.ArgumentNullException("USERNAME");
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDS.TabUserDataTable dataTable) {
        ...
        public virtual int DeleteUserByUserID(int Original_UID) {
        ...
        public virtual int InsertNewUser(string UserName, string Password, int UserLevel, string UserEmail) {
        ...
        public virtual int UpdatePassword(string Password, int UID) {
